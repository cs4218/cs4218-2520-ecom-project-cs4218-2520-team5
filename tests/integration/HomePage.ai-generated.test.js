...
import routes from '../routes'; // Import your Express routes
...
describe('POST /api/v1/product/product-filters', () => {
  test('should return filtered products based on category and price', async () => {
    ...
    const product2 = new Product({ name: 'Phone', price: 500, description: 'A smart phone', slug: 'phone', category: category._id });
    await product1.save();
    await product2.save();
